...
class MainActivity : AppCompatActivity() {
    ...
    private val mSoundResourse = arrayOf(
        R.raw.cymbal1,
        R.raw.cymbal2,
        R.raw.cymbal3,
        R.raw.tom1,
    ...
    override fun onResume () {
        ...
        mSoundPool = SoundPool.Builder()
            ...
            .setMaxStreams(mSoundResourse.size)
            .build()

        mSoundID = arrayOfNulls(mSoundResourse.size)

        for (i in 0..(mSoundResourse.size - 1)) {
            mSoundID[i] = mSoundPool.load(applicationContext, mSoundResourse[i], 0)
        }
    }
